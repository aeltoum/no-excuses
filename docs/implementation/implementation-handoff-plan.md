...
| 3. Device-private capture, media lifecycle, and Workout Proof | Workout sessions; private app storage; exactly two Proof photos; descriptions; durable drafts/upload journal; immutable object reservations; signed transfer seams; report submission; screening state; live audience visibility; quarantine; retention and deletion tombstones | 2 | Interrupted/retried/duplicate upload tests; acknowledgement only after durable object and authoritative commit; no camera-roll or metadata leakage; membership-era reads; every draft/submitted/terminal deletion path; processor fail-closed contract tests | 4–6 weeks |
...
| 7. Read models, member tasks, social delivery, and notifications | Rebuildable member/Group/Season views; task-first home; reactions/messages; social budgets/digest; in-app authority; push/email adapters; typed deep links; due-work scheduling, cancellation, bundling, retries, and stale-route recovery | 2–6 | Projection rebuild equals authoritative facts; permission-denied/offline/late/duplicate push cannot alter outcomes; daily caps and bundling pass; stale links recover safely; all applicable member screens expose loading, empty, denied, failure, conflict, and pending states | 3–4 weeks |
| 8. Safety, moderation, operator shell, and Account lifecycle | Group conduct acceptance; Safety block; Content report; Moderation case/hold/appeal; scoped operator commands and views; support; export; Account deletion workflow; Auth/Storage/processor deletion; audit pseudonymization | 2–7 | Cross-role and cross-Group denial; operator TOTP/purpose/reason/audit checks; no broad Group or infrastructure access; immediate cutoffs; seven-day active/processor deletion; 30-day backup expiry model; 90-day restricted audit expiry; outstanding-JWT deletion case | 4–6 weeks |
| 9. Integrated candidate and device acceptance | Complete 65-screen/state inventory; responsive layouts; current-major iOS/Android device integrations; screen reader, roughly 200% text, reduced motion, alternative input; camera, OTP, links, SecureStore, push, activity sources, offline/restart; release manifest | 1–8 | Gates 2 and 3 pass for immutable candidate; zero authoritative mismatch; every core flow works on one representative physical device per platform in every required accessibility mode; recorded p95 performance thresholds pass | 3–5 weeks |
| 10. Hosted operations and synthetic rehearsal | Four-environment isolation; deploy/forward-fix/migration runbooks; five-minute internal supervisory checks and independent external health check; alerting; PITR; restore-safe deletion; vendor exit; secret rotation; staff handoff; rare/failure-injected operator workflows | 9 plus approval A1 | Gate 4 passes in production-shaped hosted rehearsal; human alert within 15 minutes; structured RPO at most 15 minutes; core RTO at most four hours; deleted Proof/identity never reappear; no live data or participant credentials | 2–4 weeks |
| 11. Participant admission and guided rehearsal | Current vendor/country/privacy/cost review; exact candidate/config audit; support and break-glass verification; recruited participant onboarding; guided non-scoring week; ordinary journey/accessibility/support observation | 10 plus approvals A2–A3 | Gate 5 passes before enrollment; guided week reconciles Accounts, Groups, tasks, media, outcomes, notifications, operator actions, audits, and pilot measures; rare/destructive events remain synthetic | 2–3 weeks plus one rehearsal week |
...
Before scored activation, run one bounded developer-authored reset with operator witness. Reconcile every rehearsal Account, Group, Member-week, target, Workout report, Proof object, decision, streak, Card, Crown, standing, notification, queue/outbox item, operator action, audit receipt, and Validation-pilot measure before and after. Failure or unexplained residue blocks scored weeks.
